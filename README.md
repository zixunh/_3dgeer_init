...
$sibr_rg
```
- **For offline visualization**, We recommend using our gsplat-geer implementation, built on top of: https://github.com/nerfstudio-project/gsplat/blob/main/docs/3dgut.md (In addition, the mismatched culling issue in UT is resolved using our PBF-based fix.)
